...
const testimonials = [
  {
    quote: "Zerogravity revolutionized how we manage our unlimited storage needs. The experience is seamless and reliable.",
    author: "Otono Steven",
    role: "MD and DTP",
    company: "AirSPACEx",
    metric: { value: "∞", label: "Storage capacity" },
  },
  {
    quote: "As a marketer, I love how easy it is to organize and share content with the team across the globe.",
    author: "kirabo Creamlyn",
    role: "Marketer",
    company: "AirSPACEx",
    metric: { value: "100%", label: "Team adoption" },
  },
  {
    quote: "Zerogravity's security and global accessibility have been instrumental to our operations at AirSPACEx.",
    author: "Laker Leslie",
    role: "MD",
    company: "AirSPACEx",
    metric: { value: "99.99%", label: "Uptime guarantee" },
  },
  {
    quote: "The design systems and infrastructure behind Zerogravity is perfectly aligned with modern cloud standards.",
    author: "Okello Mathew",
    role: "MD of Design Systems",
    company: "AirSPACEx",
    metric: { value: "50+", label: "Global regions" },
  },
   {
    quote: "Zerogravity has changed my life since I'm a broke Naalya student how has no where to keep and store my work thank you AirSPACEx.",
